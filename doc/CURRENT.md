...
- Corrections are persisted in the corrections DB as header rows plus source rows plus leg rows. Source-backed deletions become tombstones by soft-deleting the correction and its source rows; source-less opening-balance deletions are hard deletes.
