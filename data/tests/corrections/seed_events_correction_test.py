...
def test_apply_seed_event_corrections_merges_and_sorts() -> None:
    ...
    seed_event = SeedEvent(
        ...
        legs=[LedgerLeg(asset_id=BTC, quantity=seed_quantity, account_id=KRAKEN_WALLET, is_fee=False)],
    )
    ...
    raw_event = LedgerEvent(
        ...
        legs=[LedgerLeg(asset_id=BTC, quantity=raw_quantity, account_id=KRAKEN_WALLET, is_fee=False)],
    )
