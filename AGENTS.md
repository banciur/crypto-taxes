...
- `GET /accounts` returns the merged account catalog used by the UI: configured wallet accounts from `artifacts/accounts.json` plus built-in system exchange accounts such as Coinbase and Kraken.
